...
SELECT item_purchased, round(AVG(review_rating::NUMERIC),2) AS "average_product_rating" FROM customer GROUP BY item_purchased ORDER BY AVG(review_rating) DESC LIMIT 5; 
...
SELECT item_purchased,round(100*SUM(CASE 
    ...
    ELSE  0
END)/COUNT(*),2) as discount_rate FROM customer 
